...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Editar Despesa</li>
      </ol>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Editar Despesa</h5>
            </div>
            <div class="card-body">
              <form action="includes/editar-despesa" method="POST" class="form-horizontal form-bordered">
                <div class="form-body">
                  <div class="form-group row">
                    <label class="control-label text-right col-md-2">Despesa</label>
                    <div class="col-md-9">
                      <input  name="despesa" value="<?php echo utf8_decode($dados['nome']); ?>"  class="form-control" type="text">
                      </div>
                  </div>
                  <div class="form-group row">
                    <label class="control-label text-right col-md-2">Data</label>
                    <div class="col-md-9">
                      <input  name="data" value="<?php echo $dados['data']; ?>" class="form-control" type="date">
                      </div>
                  </div>
                  <div class="form-group row">
