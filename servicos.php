...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
      <h4 class="text-black">Lista de Clientes </h4> 
      <p>Exporte os dados para CSV, Excel, PDF ou Faça Impressão</p>
      <a href="cadastrar-servico"><button type="button" class="btn btn-success" style="width: 56%;">+ Novo Serviço</button></a>
      <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                    ...
                    $sql = "SELECT * FROM servico order by servico asc";
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo utf8_decode($dados['servico']); ?></td>
                        <td><?php echo "R$". $val; ?></td>
                        <td style="text-align: center; !important"><a href="editar-servico?id=<?php echo $dados['id']; ?>"><i class="ti-pencil"> Editar </i></a></td>
                        <td style="text-align: center; !important"><a href="includes/excluir-servico?id=<?php echo $dados['id']; ?>"><i class="ti-trash"> Excluir </i></a></td>
                      </tr>
                    <?php  } ?>
                    </tbody>
                    <tfoot>
...
if (pesquisar != '') {
    ...
    $.post('includes/buscar-servico.php', dados, function(retorna) {
