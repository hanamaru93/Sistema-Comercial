...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Novo Serviço</li>
      </ol>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Cadastro de Serviço</h5>
            </div>
            <div class="card-body">
              <form action="includes/cadastrar-servico" method="POST" class="form-horizontal form-bordered">
                <div class="form-body">
                  <div class="form-group row">
                    <label class="control-label text-right col-md-2">Serviço</label>
                    <div class="col-md-9">
                      <input placeholder="servico" name="servico"  class="form-control" type="text">
                      </div>
                  </div>
                  <div class="form-group row">
