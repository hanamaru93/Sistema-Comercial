...
<header class="main-header"> 
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
      <h4 class="text-black">Lista de Vendas </h4> 
      <p>Exporte os dados para CSV, Excel, PDF ou Faça Impressão</p>
      <a href="cadastrar-venda"><button type="button" class="btn btn-success" style="width: 56%;">+ Nova Venda</button></a>
      <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                    ...
                    $sql = "SELECT * FROM venda order by id desc limit 0,10";
                    ...
                    while($dados = mysqli_fetch_array($query)){
                      ...
                      $des = $dados['desconto'];
                      $des = floor($des * 100) / 100;
                      $desconto = number_format($des, 2, '.', ''); 

                      $total = $vfinal - $desconto;
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align: center; !important"><a href="includes/imprimir?id=<?php echo $dados['id']; ?>" target="_blank"><i class="ti-printer"> Imprimir </i></a></td>
