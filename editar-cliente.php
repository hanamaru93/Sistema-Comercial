...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Editar Cliente</li>
      </ol>
    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header bg-blue">
              <h5 class="m-b-0">Edição de Cliente</h5>
            </div>
            <div class="card-body">
              <form action="includes/editar-cliente" method="POST" class="form-horizontal form-bordered">
                <div class="form-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input placeholder="Placa" style="text-transform: uppercase !important;" id="placa" name="placa" value="<?php echo utf8_decode($dados['placa']); ?>" class="form-control" type="text">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      <div class="row">
                        <div class="offset-sm-2 col-md-9">
                          ...
                          <a href="clientes"><button type="button" class="btn btn-inverse">Cancelar</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
