...
<header class="main-header"> 
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <a href="cadastrar-cliente"><button type="button" class="btn btn-success" style="width: 56%;">+ Novo Cliente</button></a>
                  ...
                  <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align: center; !important"><a href="editar-cliente?id=<?php echo $dados['id']; ?>"><i class="ti-pencil"> Editar </i></a></td>
                        <td style="text-align: center; !important"><a href="includes/excluir-cliente?id=<?php echo $dados['id']; ?>"><i class="ti-trash"> Excluir </i></a></td>
                      </tr>
                    <?php  } ?>
                    </tbody>
                    <tfoot>
...
if (pesquisar != '') {
    ...
    $.post('includes/busca-de-cliente.php', dados, function(retorna) {
